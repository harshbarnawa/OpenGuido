...
const INTENT_MAP: Record<string, string[]> = {
    ...
    // ── String manipulation ─────────────────────────────────────────────
    'split string':                       ['string stringstream', 'string getline', 'string split by delimiter'],
    ...
    'design pattern cpp':                 ['factory method pattern', 'observer pattern', 'strategy pattern'],
    'creational pattern':                 ['factory method pattern', 'builder pattern'],
    'behavioural pattern':                ['observer pattern', 'strategy pattern'],

    // ── Advanced CP / data structures ────────────────────────────────────
    'sparse table':                       ['sparse table'],
    'RMQ':                                ['sparse table'],
    'range minimum query':                ['sparse table', 'segment tree build'],
    ...
    'order_of_key':                       ['policy based data structures'],
    'find_by_order':                      ['policy based data structures'],
    'linear sieve':                       ['sieve linear'],
    'smallest prime factor':              ['sieve linear'],

    // ── Modern C++ style / patterns ──────────────────────────────────────
    'std::format':                        ['std format'],
    'format string':                      ['std format'],
    'coroutine':                          ['coroutine basic'],
    'generator':                          ['coroutine basic'],
    'co_yield':                           ['coroutine basic'],
    'source_location':                    ['source location'],
    'std::bit':                           ['std bit operations'],
    'bit operations':                     ['std bit operations'],
    'popcount':                           ['std bit operations', 'count set bits'],
    'bit_ceil':                           ['std bit operations'],
    'spanstream':                         ['std spanstream'],
    'std::expected':                      ['std expected'],
    'expected result':                    ['std expected'],
    'string split':                       ['string split by delimiter'],
    'overloaded pattern':                 ['lambda overloaded pattern'],
    'lambda visitor':                     ['lambda overloaded pattern'],
